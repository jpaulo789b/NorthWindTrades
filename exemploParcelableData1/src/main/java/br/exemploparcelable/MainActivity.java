...
import br.exemploparcelable.domain.Discipline;
import br.exemploparcelable.domain.Student;
import br.exemploparcelable.domain.Team;
...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Student 1
			...
			disciplines.add(new Discipline(1, "Matem�tica"));
			disciplines.add(new Discipline(2, "Portugu�s"));
		...
		// Student 2
			disciplines = new ArrayList<Discipline>();
			disciplines.add(new Discipline(1, "Matem�tica"));
			disciplines.add(new Discipline(3, "Hist�ria"));
		...
		// Student 5
			disciplines = new ArrayList<Discipline>();
			disciplines.add(new Discipline(5, "Ingl�s"));
